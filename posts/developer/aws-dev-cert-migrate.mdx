...
<Box display='flex' ml='auto' mr='auto' justifyContent='center'>
    ...
    <Image src='/aws-certified-developer-associate (1).png' alt='devcert' borderRadius='full' boxSize='450px'/>
    </Link>
    </Box>