...
const getStaticProps = async ()=>{
    const postPaths = path__WEBPACK_IMPORTED_MODULE_3___default().join(process.cwd(), "posts/sports");
...
var __webpack_exports__ = __webpack_require__.X(0, [505,664,374,409], () => (__webpack_exec__(138)));
